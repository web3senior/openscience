...
function Data({ title }) {
  ...
  const getData = async () => await contract.methods.getData(params.id).call()
          ...
          <div className="ms-Grid" dir="ltr">
            <div className="ms-Grid-row">
              <div className="ms-Grid-col ms-sm6 ms-md4 ms-lg3">
                {data.list &&
                  ...
                  data.list.map((item, i) => (
                    <div key={i} className={`${styles['data__item']} card`}>
              ...
              <div className="ms-Grid-col ms-sm6 ms-md8 ms-lg9">
                ...
                <article>
                  <h3 className={`mt-20`}>Abstracct</h3>
                  <p>
                    Elderly population has been progressively rising in the world, thus the demand for anti-aging heath products to assure longevity as well as to ameliorate age-related complications is also on the rise. Among various anti-aging
                    health products, nicotinamide mononucleotide (NMN) has been gaining attentions of the consumers and the scientific community.
                  </p>
                </article>
                ...
                <p className='mt-10'>
                  <b>{web3.utils.fromWei(web3.utils.toNumber(3000000000000000000), `ether`)} $ARB</b>
                </p>
